...
import { StyledImg, StyledPTag, StyledH1, StyledH2, StyledH3, StyledH4, StyledH5, StyledH6, } from './project.styles'
...
function ProjectTemplate({ data }) {
  ...
  const options = {
    ...
    renderNode: {
      [BLOCKS.PARAGRAPH]: (node, children) => <StyledPTag>{children}</StyledPTag>,
